		...
		<div class="wrapper">
			...
			<div class="footer">
				<div class="footer-bottom">
					<div class="left">&copy; Copyright 2016 <strong>Activ Gaming </strong> - Version <?= $website['version']; ?> - Développé par Dekadmin & Darcks28</div>
		...
		<!-- <script type='text/javascript' src='assets/jscript/rangyinputs-jquery-1.1.2.min.js'></script>
		<script type='text/javascript' src='assets/jscript/rangy-core.js'></script>
		<script type='text/javascript' src='assets/jscript/rangy-selectionsaverestore.js'></script> -->
